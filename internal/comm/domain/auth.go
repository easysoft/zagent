...
type Auth struct {
	AuthType     consts.AuthType `json:"type" yaml:"type"`
...
type OAuth2Entity struct {
	...
	GrantType   consts.OAuth2TypeGrantType `json:"grantType" yaml:"grantType"`
	...
	CodeChallengeMethod consts.CodeChallengeMethod `json:"codeChallengeMethod" yaml:"codeChallengeMethod"` // SHA-256 or Plain
	CodeVerifier        string                     `json:"codeVerifier" yaml:"codeVerifier"`               // random string

	ClientAuthentication consts.OAuth2ClientAuthType

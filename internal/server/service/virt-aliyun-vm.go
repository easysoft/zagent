...
func (s AliyunVmService) CreateRemote(hostId, backingId, queueId uint) (result _domain.RemoteResp) {
	...
	if err != nil {
		...
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "CreateEcsClient fail %s"+err.Error(), queueId, vm.ID, 0, "", "", "")
		return
	}
	...
	if err != nil {
		result.Fail(err.Error())
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "GetSwitch fail %s"+err.Error(), queueId, vm.ID, 0, "", "", "")
		return
	}
	...
	if err != nil {
		result.Fail(err.Error())
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "QuerySecurityGroupByVpc fail %s"+err.Error(), queueId, vm.ID, 0, "", "", "")
		return
	}
	...
	if err != nil {
		result.Fail(err.Error())
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "CreateInst fail %s"+err.Error(), queueId, vm.ID, 0, "", "", "")
		return
	}
	...
	if err != nil {
		result.Fail(err.Error())
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "StartInst fail %s"+err.Error(), queueId, vm.ID, 0, "", "", "")
		return
	}
	...
	for i := 0; i < 2*60; i++ {
		...
		if err != nil {
			result.Fail(err.Error())
			s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "QueryInst fail %s"+err.Error(), queueId, vm.ID, vm.VncPort, vm.VncUrl, "", "")
			return
		}
	...
	if err != nil {
		result.Fail(err.Error())
		s.VmCommonService.SaveVmCreationResult(result.IsSuccess(), "AllocateIp fail %s"+err.Error(), queueId, vm.ID, vm.VncPort, vm.VncUrl, "", "")
		return
	}
	...
	vm.VncUrl, _ = s.AliyunEcsService.QueryVncUrl(

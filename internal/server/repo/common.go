...
// GetAll 批量查询
func (r *CommonRepo) GetAll(model interface{}, s *commDomain.Search) *gorm.DB {
...
// Found 查询条件
func (r *CommonRepo) Found(s *commDomain.Search) *gorm.DB {
...
// Relation 加载关联关系
func (r *CommonRepo) Relation(relates []*commDomain.Relate) func(db *gorm.DB) *gorm.DB {
...
// FoundByWhere 查询条件
func (r *CommonRepo) FoundByWhere(fields []*commDomain.Filed) func(db *gorm.DB) *gorm.DB {
	return func(db *gorm.DB) *gorm.DB {
		if len(fields) > 0 {
...
func (r *CommonRepo) GetRelations(relation string, fs map[string]interface{}) []*commDomain.Relate {
...
func (r *CommonRepo) GetSearch(key, search string) *commDomain.Filed {
	if len(search) > 0 {
